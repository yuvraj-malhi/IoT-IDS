...
Original file is located at
    https://colab.research.google.com/drive/1HNjGObAszxnuM_RbsMZTWWIv7p5rJlLd
"""
...
sh_file   = '/content/drive/MyDrive/Data/'+model
P1 = sh_file + '1'
P2 = sh_file + '2'
...
MODEL.add(tf.keras.layers.Dense(units=122,kernel_initializer='RandomNormal',activation='relu'));                     ## C Point - Input  layer  size
MODEL.add(tf.keras.layers.Dense(units=30,kernel_initializer='RandomNormal',activation='relu'));                      ## C Point - First  hidden layer size
MODEL.add(tf.keras.layers.Dense(units=60,kernel_initializer='RandomNormal',activation='relu'));                      ## C Point - Second hidden layer size
MODEL.add(tf.keras.layers.Dense(units=30,kernel_initializer='RandomNormal',activation='relu'));                      ## C Point - Fourth  hidden layer size
MODEL.add(tf.keras.layers.Dense(units=15,kernel_initializer='RandomNormal',activation='relu'));                      ## C Point - Third  hidden layer size
MODEL.add(tf.keras.layers.Dense(units=Y_train.shape[1],activation='softmax'));                    ## C Point - Output layer size

MODEL.compile(optimizer = 'adam', loss = 'categorical_crossentropy', metrics =['accuracy']);
#Y_train = pd.DataFrame(Y_train)
MODEL.fit(X_train, Y_train, batch_size=32, epochs = 25, validation_split=0.33, verbose=0);
...
MODEL2.add(tf.keras.layers.Dense(units=X2.shape[1],kernel_initializer='RandomNormal',activation='relu'));                     ## C Point - Input  layer  size
MODEL2.add(tf.keras.layers.Dense(units=30,kernel_initializer='RandomNormal',activation='relu'));                      ## C Point - First  hidden layer size
MODEL2.add(tf.keras.layers.Dense(units=60,kernel_initializer='RandomNormal',activation='relu'));                      ## C Point - Second hidden layer size
MODEL2.add(tf.keras.layers.Dense(units=15,kernel_initializer='RandomNormal',activation='relu'));                      ## C Point - Third  hidden layer size

MODEL2.add(tf.keras.layers.Dense(units=Y2.shape[1],activation='softmax'));                    ## C Point - Output layer size

MODEL2.compile(optimizer = 'adam', loss = 'categorical_crossentropy', metrics =['accuracy']);
MODEL2.fit(X2, Y2, batch_size=32, epochs = 250, validation_split=0.33, verbose=0);
...
tf.keras.models.save_model(MODEL, P1)
directory = P1
...
tf.keras.models.save_model(MODEL2, P2)
directory = P2
total = 0
total = folder_size(P2)
