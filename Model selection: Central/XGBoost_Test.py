...
Original file is located at
    https://colab.research.google.com/drive/1e7BQkZr8lG3i7SvxCPgUr4Dh4SGnMwfY
"""
...
for str1 in ['normal.','smurf.', 'neptune.']:
  ...
  if str1 == 'normal.':
    new = new.sample(n=200000, replace=False, random_state=1 ); ############################# Change
  else:
    new = new.sample(n=200000, replace=False, random_state=1 );
  df_down.drop(df_down[df_down['41']==str1].index ,inplace=True) ############################# Change
