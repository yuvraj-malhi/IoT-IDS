# -*- coding: utf-8 -*-
"""EdDt_Extra_Tests.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16Nl8RicFHuEroq1uAFTmCMusPEXVUP2S
"""
...
plt.title('Protocol based accuracies for EdDt');
...
plt.title('Service based accuracies for EdDt');
plt.legend(handles=[p1,p2], loc = 'upper right');
plt.show();
...
plt.xticks(x,names);
plt.grid(linestyle='--')
plt.title('Service based accuracies fo EdDt');
plt.legend(handles=[p1,p2], loc = 'upper right');
plt.show();